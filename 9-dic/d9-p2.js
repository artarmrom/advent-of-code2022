...
function moveUp(map, coord, part, mark){
    ...
    map[coord.row][coord.col]=part
}
function moveDown(map, coord, part, mark){
    map[coord.row][coord.col]=mark
    if(map[coord.row+1]===undefined)
    createRowDown(map[coord.row].length)
    coord.row=coord.row+1
    map[coord.row][coord.col]=part
}
function moveLeft(map, coord, part, mark){
    map[coord.row][coord.col]=mark
...
function moveRight(map, coord, part, mark){
    map[coord.row][coord.col]=mark
    coord.col=coord.col+1
    if(map[coord.row][coord.col]===undefined)
        createColumnRight()
    map[coord.row][coord.col]=part
}
function moveDiagonal(map, coord, row, col, part, mark){
    map[coord.row][coord.col]=mark
    coord.row=row
    coord.col=col
    map[row][col]=part
